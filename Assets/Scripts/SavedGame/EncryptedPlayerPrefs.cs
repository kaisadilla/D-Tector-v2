...
public class EncryptedPlayerPrefs  {
    ...
    // Modify this key in this file: (original: "9ETrEsWaFRach3gexaDr")
    private static string privateKey = "k8aFjiGowoTGj98X76ga";

    // Add some values to this array before using EncryptedPlayerPrefs
    public static string[] keys = {
        "ITtosaf3mG6iPRR1GuYt",
        "Gv78SFHsf09asdgj9e8g",
        "dvz97dghbSAsfhd78DGS",
        "rgsb897HSDFxx9shsfh8",
        "LzxbE3hsNe34I2345Nah"
    };
